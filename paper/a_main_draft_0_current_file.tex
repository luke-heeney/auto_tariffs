...
\input{generated/tables/cost_reg_table}
...
\input{generated/tables/cf_summary_table}
...
\input{generated/tables/summary_by_type}
...
\input{generated/tables/cf_summary_table_full}
...
\input{generated/tables/cost_reg_placebo_levels_table}

\clearpage

\input{generated/tables/cost_reg_placebo_fd_table}

\clearpage

\input{generated/tables/cost_reg_timing_triplet_levels_table}

\clearpage

\input{generated/tables/cost_reg_timing_triplet_fd_table}

\clearpage
\subsection{Interpreting the One-Year-Ahead Exchange-Rate Coefficient}

The positive \(RER_{t+1}\) implies that future cost shocks have some impact on contemporaneous marginal costs. This is plausible given multi-year contracts for parts that are common in the automotive industry; contract prices may be set in part as a function of expected future exchange rate shifts. 

However, this challenges our assumption of 'no anticipation' that allows us to claim that $RER_t$ is exogenous with respect to lagged import exposure $\rho_{t-1}$. If marginal costs respond to future exchange rate shocks through an anticipation channel, parts sourcing may also be responsive to expected future exchange movements.


\subsection{Prices, Marginal Costs, and Markups}

\input{generated/tables/cost_reg_price_markup_decomp_table}
...
\input{generated/tables/leave_one_country_out_report_table}
